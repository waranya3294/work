...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a href="room.php" class="nav-link">สร้างห้องสอบ</a>
                        </li>
                        <li class="nav-item">
                            <a href="exam_form.php" class="nav-link">สร้างข้อสอบ</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link">ข้อสอบของฉัน</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link">ข้อมูลทั้งหมด</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="main-content">
        <h1 class="text-center">ห้องสอบ</h1>
        <button class="mb-4" onclick="window.location.href='form.php'">สร้างห้องสอบ</button>
                ...
                <div class="col-12 mb-3">
                    <div class="row">
                        <div class="card shadow-sm h-100 card-custom">
                            <div class="card-body">
                                <h5 class="card-title text-primary"><?= htmlspecialchars($row['form_name']) ?></h5>
                                <p class="card-text">
                                    <strong>รหัสเข้าห้องสอบ:</strong> <?= htmlspecialchars($row['form_code']) ?><br>
                                    <strong>ประเภท:</strong> <?= htmlspecialchars($row['form_category']) ?><br>
